...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name ,COUNT(character_books.book_id)  from characters INNER JOIN character_books ON characters.id = character_books.book_id GROUP BY characters.name ;"
end
