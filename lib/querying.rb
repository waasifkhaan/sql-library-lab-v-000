...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters ON characters.series_id = series.id GROUP BY characters.species HAVING characters.species = 'human' ORDER BY COUNT(characters.species) asc LIMIT 1; "
end
